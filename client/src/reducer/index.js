import { GET_RECIPES, GET_TYPES_DIETS , FILTER_TYPES_DIETS, FILTER_SCORE} from "../actions";
...
const rootReducer = (state = initialValues, {type, payload}) => {
    ...
    switch(type){
        ...
        case FILTER_SCORE:
            ...
            if(payload === 'All'){return {...state, recipes: AllRecipes}}
            else if(payload === 'bajo'){return {...state, recipes: AllRecipes.filter(recipe => recipe.score <= 10)}}
